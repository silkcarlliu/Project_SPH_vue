                ...
                <div class="title clearfix">
                    ...
                    <div class="fr">
                        <ul class="nav-tabs clearfix">
                            <li @mouseenter="navEnter(item.text)" :class="{active: currentNav === item.text}" v-for="(item, index) in floorList.navList" :key="item.text">
...
export default {
  ...
  data() {
    return {
      currentNav: this.floorList?.navList[0]?.text || "",
    };
  },
  methods: {
    navEnter(text) {
